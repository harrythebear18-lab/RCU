...
title RAM Sharing Manager Launcher
echo="==============================================="
echo    RAM SHARING MANAGER LAUNCHER
echo="==============================================="
echo.
echo Starting graphical RAM sharing interface...
echo.
...
if not exist "RAM_Sharing_GUI.py" (
    echo ERROR: RAM_Sharing_GUI.py not found
...
REM Launch the GUI
echo Launching RAM Sharing GUI...
