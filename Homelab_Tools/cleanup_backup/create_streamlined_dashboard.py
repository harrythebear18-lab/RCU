#!/usr/bin/env python3
"""
Create Streamlined Dashboard
Creates a streamlined dashboard with main tool categories, live stats, and launch buttons
"""
...
class StreamlinedDashboard:
    ...
    def __init__(self):
        ...
        # Main categories with representative tools
        self.categories = {
            'System Monitoring': {
                'icon': '📊',
                'color': '#00ff88',
                'tools': ['CPU Monitor', 'GPU Monitor', 'Network Monitor', 'Storage Monitor', 'RAM Monitor'],
            ...
            'Distributed Computing': {
                'icon': '⚡',
                'color': '#0078ff',
                'tools': ['RDMA Desktop App', 'RDMA Modern App', 'Memory Portal', 'Hybrid Compute'],
            ...
            'Infrastructure & Management': {
                'icon': '🏗️',
                'color': '#ff6b6b',
                'tools': ['Web Dashboard', 'VPN Gateway', 'Backup Manager', 'Power Manager', 'Container Manager'],
            ...
            'Network & Security': {
                'icon': '🔐',
                'color': '#ffaa00',
                'tools': ['Mesh VPN Server', 'Mesh VPN Client', 'WireGuard Installer'],
            ...
            'RAM Sharing': {
                'icon': '🖥️',
                'color': '#00d4ff',
                'tools': ['RAM Sharing Manager', 'Simple RAM Sharing'],
                'launch_tool': 'RAM_Sharing_GUI.py',
                'description': 'Cross-PC memory sharing and optimization'
            },
            'System Tools': {
                'icon': '🛠️',
                'color': '#ff6b6b',
                'tools': ['System Integration Test', 'Homelab Launcher', 'Comprehensive Audit'],
    ...
    def launch_tool(self, tool_name, tool_path):
        ...
        try:
            ...
            is_gui = tool_path.endswith('.py')
            
            if is_gui:
                # Launch GUI application
                if os.name == 'nt':  # Windows
                    subprocess.Popen(['python', tool_path], 
                                   cwd=os.path.dirname(tool_path) or '.',
