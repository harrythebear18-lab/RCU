...
class HomelabPortal:
    ...
    def __init__(self, node_id: str = None, port: int = 8080):
        ...
        # Initialize Windows Assistant integration
        if ASSISTANT_INTEGRATION_AVAILABLE and EVENT_BUS_AVAILABLE:
            self.assistant_integration = WindowsAssistantIntegration(self.event_bus, self.logger)
        else:
            self.assistant_integration = None
        
        # Core services with availability checks
        ...
        # Hardware optimizers (conditional initialization)
    ...
    def discover_network_devices(self):
        ...
        try:
            ...
            discovered = self.network_discovery.discover_devices()
    ...
    def get_status(self):
        ...
        # Portal state
        self.active_nodes: Dict[str, PortalNode] = {}
        self.active_sessions: Dict[str, ShareSession] = {}
        ...
        # Logging
        self.logger = logging.getLogger("HomelabPortal")
        self.logger.setLevel(logging.INFO)
...
class PortalGUI:
    ...
    def on_window_close(self):
        ...
        try:
            self.portal.stop_portal_server()
            self.root.quit()
        except:
            self.root.quit()
